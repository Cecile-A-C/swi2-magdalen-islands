...
def arithmetic_K(hk_1,thk1,hk_2,thk2):
    ...
    ''' Compute the equivalent perpendicular hydraulic conductivity = 
    arithmetic mean of individual hydraulic condutivities '''
...
def write_df_to_dat(file_path, file_name, df, columns):
